...
export class RenderService {
    ...
    public loadLines() {
        Plotly.d3.csv('/source/3d-source.1.csv', (err, rows) => {
            ...
            let point1 = new THREE.Vector3(this.unpack(rows, 'x1'), this.unpack(rows, 'y1'), this.unpack(rows, 'z1'));
            let point2 = new THREE.Vector3(this.unpack(rows, 'x2'), this.unpack(rows, 'y2'), this.unpack(rows, 'z2'));
